/* Sakura Trip Companion loader v17 */
(function loadSakuraTripCompanion(){
  'use strict';
  if(window.__sakuraTripCompanionLoadingV17)return;
  window.__sakuraTripCompanionLoadingV17=true;
  ...
  (async()=>{
    try{
      ...
      window.__sakuraTripCompanionLoadingV17=false;
    }
  })();
}());
