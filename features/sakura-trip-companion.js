/* Sakura Trip Companion loader v8 */
(function loadSakuraTripCompanion(){
  'use strict';
  if(window.__sakuraTripCompanionLoadingV8)return;
  window.__sakuraTripCompanionLoadingV8=true;
  ...
  (async()=>{
    try{
      ...
      window.__sakuraTripCompanionLoadingV8=false;
    }
  })();
}());
