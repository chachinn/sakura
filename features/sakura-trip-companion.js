...
(function loadSakuraTripCompanion(){
  ...
  const assets=[
    ...
    ['./features/sakura-trip-companion-stabilize.js?v=1','sakura-trip-companion-stabilizer']
  ];
  ...
  const ready=key=>
    ...
    (key==='sakura-trip-companion-stabilizer'&&window.SakuraTripCompanionStabilizer?.version>=1);
